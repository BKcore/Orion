    ...
    <div id="header">
        <div id="header-top">
            <div class="global-container">
                ...
                <div id="header-nav">
                    <a href="{$orion.baseurl}login.o/logout">Log out</a> -
        ...
        <div id="header-menu">
            <div class="global-container">
                ...
                {if $item@iteration neq 1} &bull; {/if}<a href="{$orion.baseurl}{$item->module}{$item->route}" {if $item->module eq $orion.module.uri}class="active"{/if}>{$item->text}</a>
                {/foreach}
            </div>
        </div>
        <div id="header-submenu">
            <div class="global-container">
                ...
                {if $mitem@iteration neq 1} &bull; {/if}<a href="{$orion.baseurl}{$mitem->module}{$mitem->route}">{$mitem->text}</a>
                {/foreach}
            </div>
        </div>
    </div>
